...
plot(inflow_data[,"HP1"],type="l",col="blue",ylab=expression("Inflow [m"^3* "/s]")) 
plot(inflow_data[,"HP1"],type="l",col="blue",ylab=expression("Inflow [m"^3* "/s]"),main="Historical Inflow Data for HP1") 
